...
int main(int argc, char *argv[]) {
  ...
  10:	38c080e7          	jalr	908(ra) # 398 <pipe>
    pipe(pi2);
  14:	fe040513          	add	a0,s0,-32
  18:	00000097          	auipc	ra,0x0
  1c:	380080e7          	jalr	896(ra) # 398 <pipe>

    buf1 = '0'; /* init'd to '0' for testing */
  20:	03000793          	li	a5,48
  24:	fcf40fa3          	sb	a5,-33(s0)
    buf2 = '0';
  28:	fcf40f23          	sb	a5,-34(s0)
  ...
  32:	87258593          	add	a1,a1,-1934 # 8a0 <malloc+0xe8>
  36:	fec42503          	lw	a0,-20(s0)
  3a:	00000097          	auipc	ra,0x0
  3e:	36e080e7          	jalr	878(ra) # 3a8 <write>

    if (fork() == 0) {
  42:	00000097          	auipc	ra,0x0
  46:	33e080e7          	jalr	830(ra) # 380 <fork>
  4a:	e525                	bnez	a0,b2 <main+0xb2>
        if (read(pi1[0], &buf1, 1) == 1) {
  4c:	4605                	li	a2,1
  4e:	fdf40593          	add	a1,s0,-33
  52:	fe842503          	lw	a0,-24(s0)
  56:	00000097          	auipc	ra,0x0
  5a:	34a080e7          	jalr	842(ra) # 3a0 <read>
  5e:	4785                	li	a5,1
  60:	02f50b63          	beq	a0,a5,96 <main+0x96>
            pid = getpid();
  ...
  68:	85c58593          	add	a1,a1,-1956 # 8c0 <malloc+0x108>
  6c:	4509                	li	a0,2
  6e:	00000097          	auipc	ra,0x0
  72:	664080e7          	jalr	1636(ra) # 6d2 <fprintf>
                    "Child did not receive 1 byte\n");
        }
        write(pi2[1], "1", 1);
  76:	4605                	li	a2,1
  78:	00001597          	auipc	a1,0x1
  7c:	82858593          	add	a1,a1,-2008 # 8a0 <malloc+0xe8>
  ...
  a4:	80850513          	add	a0,a0,-2040 # 8a8 <malloc+0xf0>
  a8:	00000097          	auipc	ra,0x0
  ac:	658080e7          	jalr	1624(ra) # 700 <printf>
  b0:	b7d9                	j	76 <main+0x76>
    }
    else {
        if (read(pi2[0], &buf2, 1) == 1) {
  b2:	4605                	li	a2,1
  b4:	fde40593          	add	a1,s0,-34
  b8:	fe042503          	lw	a0,-32(s0)
  bc:	00000097          	auipc	ra,0x0
  c0:	2e4080e7          	jalr	740(ra) # 3a0 <read>
  c4:	4785                	li	a5,1
  c6:	02f50063          	beq	a0,a5,e6 <main+0xe6>
            pid = getpid();
  ...
  ce:	82e58593          	add	a1,a1,-2002 # 8f8 <malloc+0x140>
  d2:	4509                	li	a0,2
  d4:	00000097          	auipc	ra,0x0
  d8:	5fe080e7          	jalr	1534(ra) # 6d2 <fprintf>
  ...
  ea:	322080e7          	jalr	802(ra) # 408 <getpid>
  ee:	85aa                	mv	a1,a0
            printf("%d: received pong\n", pid);
  f0:	00000517          	auipc	a0,0x0
  f4:	7f050513          	add	a0,a0,2032 # 8e0 <malloc+0x128>
  f8:	00000097          	auipc	ra,0x0
  fc:	608080e7          	jalr	1544(ra) # 700 <printf>
...
0000000000000430 <getNumFreePages>:
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 480:	4fc50513          	add	a0,a0,1276 # 978 <digits>
 484:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 584:	3a070713          	add	a4,a4,928 # 920 <malloc+0x168>
 ...
 60e:	36eb8b93          	add	s7,s7,878 # 978 <digits>
 ...
 662:	2ba90913          	add	s2,s2,698 # 918 <malloc+0x160>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 814:	80078793          	add	a5,a5,-2048 # 1010 <base>
